...
/**
 * CreateMessageModal - Modal específico para criar surpresa tipo mensagem
 *
 * @param {Object} props
 * @param {Function} props.onClose - Callback ao fechar modal
 * @param {Function} props.onSubmit - Callback ao submeter (surpriseData)
 */
export default function CreateMessageModal({ onClose, onSubmit }) {
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border-2 border-theme rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 transition-all"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 border-2 border-theme rounded-xl focus:ring-2 focus:ring-accent-500 focus:border-accent-500 min-h-[180px] transition-all"
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="flex-1 px-6 py-3 bg-accent-500 hover:bg-accent-600 text-white rounded-xl transition-all font-bold shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
